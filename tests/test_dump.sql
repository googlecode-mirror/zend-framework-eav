...
--
-- Table structure for table `eav_entity_string`
--

DROP TABLE IF EXISTS `eav_entity_string`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `eav_entity_string`
--

LOCK TABLES `eav_entity_string` WRITE;
/*!40000 ALTER TABLE `eav_entity_string` DISABLE KEYS */;
/*!40000 ALTER TABLE `eav_entity_string` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2010-02-06 22:34:45
